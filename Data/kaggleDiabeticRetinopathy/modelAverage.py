...
import numpy, scipy, _pickle as cPickle
...
validationX = numpy.array([validationData["left"][n] + validationData["right"][n] for n in validationN] + [
    validationData["right"][n] + validationData["left"][n] for n in validationN])
validationY = numpy.array(
    [validationClasses["left"][n] for n in validationN] + [validationClasses["right"][n] for n in validationN])
...
# TODO: casos que sólo están en todo el test set
...
testX = numpy.array(
    [testData["left"][n] + testData["right"][n] for n in testN] + [testData["right"][n] + testData["left"][n] for n in
                                                                   testN])
...
# print >>f, "image,level" # python 2 syntax
print("image,level", file=f)
